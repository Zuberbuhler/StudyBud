...
public class Loader {
	...
	private int taskArraySize = 0; //initial set when reading username.txt
	
	int timeLogArraySize = 0;
	private simpleTimer[] timeLogArray;
	
	
	//what needs to be saved and return to GUI from login
	private ObservableList<Task> observableList_TaskTableData;
	...
	private Task buildTask(String taskName, String dueDate, String courseName, String completed)
	{
	...
	private void printTimeLogArray()
	{
	...
	private ObservableList<Task> getObservableArrayList()
	{
...
//			}
	...
	private void readUserInfoFile(String username)
	{
		usernameFile = getUsernameFile(username);
		taskArray = null;
		timeLogArray = null;
	...
	private void writeUserInfoFile(String username)
	{
		usernameFile = getUsernameFile(username);
		clearFile();
