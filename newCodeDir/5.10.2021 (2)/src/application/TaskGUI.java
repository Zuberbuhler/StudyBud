...
public class TaskGUI {
	...
	public VBox createTable() {
	    ...
	    column4.setCellFactory(CheckBoxTableCell.forTableColumn(new Callback<Integer, ObservableValue<Boolean>>() {

            @Override
            public ObservableValue<Boolean> call(Integer arg0) {
                // TODO Auto-generated method stub
                //Task task = getObservableList.get(param);
...
//		{
//			if(column4.getCellData(i) == true)
//			{
//				tableData.get(i).setCompletedStatus(true);
//			}
//			
//		}
//	}
